...
public class LocationSelectorAdapter extends RecyclerView.Adapter<LocationSelectorAdapter.ViewHolder> {
    ...
    private List<FSResults> results;
    ...
    public LocationSelectorAdapter(Context context, List<FSResults> results) {
        this.context = context;
        this.results = results;
    }
    @Override
    public LocationSelectorAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_location_selector, parent, false);
